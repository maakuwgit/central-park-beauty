...
if ( ! function_exists('register_team_taxonomies') ) {
  ...
  function register_team_taxonomies() {
    ...
    $labels = array(
      ...
      'new_item_name'                => __( 'New Education' ),
      'separate_items_with_commas'   => __( 'Separate Education with commas' ),
      'add_or_remove_items'          => __( 'Add or remove Team' ),
      'choose_from_most_used'        => __( 'Choose from the most used Education' ),
    ...
    register_taxonomy( 'team_education', 'team', $args );
