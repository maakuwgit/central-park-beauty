...
<header class="navbar" role="banner">
  <div class="container-full">
    ...
    <div class="navbar-header">
      ...
      <div class="top-nav">
        ...
        <div class="header__top-right">
          <ul class="top-right">
            ...
            <li><button type="button" class="navbar-toggle navbar-toggle--stand"><svg class="icon icon-smartphone"><use xlink:href="#icon-smartphone"></use></svg> <span class="header__top-right-text"><?php echo $phone_number; ?></span></button></li>
          </ul>
        </div>
      </div>
      ...
      <div class="primary-nav location-nav" id="location">
        <h3>here's a toggle location nav</h3>
      </div>

      <div class="primary-nav consultation-nav" id="consultation">
        <h3>here's a toggle consultation nav</h3>
      </div>

      <div class="primary-nav schedule-nav" id="schedule">
        <h3>here's a toggle schedule nav</h3>
      </div>
